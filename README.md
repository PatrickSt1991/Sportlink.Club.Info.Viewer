...
Welkom bij **Sportlink Club Viewer** – dé oplossing voor sportverenigingen om wedstrijdinformatie real-time en overzichtelijk te tonen op schermen binnen de club, zoals in de kantine of op een Smart TV.   
Neem een kijkje in de [online versie](https://clubinfoboard.madebypatrick.nl/)
---

## ⚙️ Wat is Sportlink Club Viewer?

**Sportlink Club Viewer** is een moderne webapplicatie, gebouwd met Vue 3 en Vite. De applicatie haalt automatisch sportgegevens op en presenteert deze visueel aantrekkelijk op schermen. Denk aan:
...
**Sportlink Club Viewer** is beschikbaar in vier vormen, afhankelijk van jouw voorkeur:

---

### 🌐 Online (gehoste versie)

Gebruik de [online versie](https://clubinfoboard.madebypatrick.nl/) direct in je browser.  
✅ Altijd up-to-date  
...
**Sportlink Club Viewer is volledig gratis** en beschikbaar onder de **MIT-licentie**.  
...
Veel plezier met het gebruik van **Sportlink Club Viewer**! 🎉